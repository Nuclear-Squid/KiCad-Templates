...
class SCH_Templates:
    CAN_BUFFER = HierarchicalObject(
        ...
        sheet_file="subsystems/can_buffer/can_buffer.kicad_sch",
        at_xy=[0,0],
        size_wh=[30,20],
    ...
    CAPT_TEMP = HierarchicalObject(
        ...
        sheet_file="subsystems/capt_temp/capt_temp.kicad_sch",
        at_xy=[0,0],
        size_wh=[30,20],
    ...
    BME680 = HierarchicalObject(
        sheet_name = "BME680",
        sheet_file="subsystems/s_bme680/s_bme680.kicad_sch",
        at_xy=[0,0],
        size_wh=[30,20],
        properties={"Comment": "Temperature Sensor"},
        pins=[
    ...
    ACC_MAG = HierarchicalObject(
        sheet_name = "ACC_MAG",
        sheet_file="subsystems/acc_mag/acc_mag.kicad_sch",
        at_xy=[0,0],
        size_wh=[30,20],
    ...
    MIKROBUS = HierarchicalObject(
        sheet_name = "MIKROBUS",
        sheet_file="subsystems/mikrobus/mikrobus.kicad_sch",
        at_xy=[0,0],
        size_wh=[30,20],
    ...
    I2C_PERIPHERALS = HierarchicalObject(
        ...
        sheet_file="subsystems/i2c_peripherals/i2c_peripherals.kicad_sch",
        at_xy=[0,0],
        size_wh=[30,20],
